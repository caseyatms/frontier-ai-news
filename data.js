...
window.DASHBOARD_DATA = {
  lastUpdated: "2026-07-12T12:06:00",
  version: 13,
  ...
  frontier: [
    ...
    { date:"2026-07-02", sort:"2026-07-02T19:00", cat:"policy", flag:"", src:"Fortune",
      title:"Fortune: Altman seeks an AI 'new world order' as OpenAI loses ground to Google and Anthropic",
      body:"OpenAI is slowly ceding the frontier race — Anthropic is on course for $47B revenue and 2029 profitability (a year ahead of OpenAI, whose latest disclosures sit at $25–33B) — the competitive backdrop to Altman's government-stake pitch and Washington charm offensive.",
    ...
    { date:"2026-07-01", sort:"2026-07-01T16:00", cat:"policy", flag:"", src:"AI Weekly / FT",
      title:"White House nears voluntary frontier-model release deal with OpenAI, Google & Anthropic",
      body:"Per FT reporting, the administration is finalizing voluntary pre-release standards under the June 2 frontier-security EO: classified cyber-capability benchmarks and an up-to-30-day government testing window, with CAISI and the NSA in key roles. The capability threshold that triggers review is the main sticking point; the deal follows the Fable 5 export action and GPT-5.6's staggered rollout.",
